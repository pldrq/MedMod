...
class VICReg(pl.LightningModule):
    ...
    def vicreg_loss(self, feats_ehr, feats_img, mode="train"):
        ...
        cov_loss = self.off_diagonal(cov_x).pow_(2).sum().div(num_features) + self.off_diagonal(cov_y).pow_(
            2,
    ...
    def training_step(self, batch):
        ...
        return {
            "loss": loss,
            "feats_ehr": feats_ehr.detach().cpu(),
            "feats_img": feats_img.detach().cpu(),
            "y_ehr": y_ehr,
        }
    ...
    def test_step(self, batch):
        ...
        return {
            "loss": loss,
            "feats_ehr_0": feats_ehr_0.detach().cpu(),
